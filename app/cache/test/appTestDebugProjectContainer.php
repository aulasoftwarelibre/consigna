...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'WebProfilerExtraBundle' => 'Elao\\WebProfilerExtraBundle\\WebProfilerExtraBundle',
                'h4ccAliceFixturesBundle' => 'h4cc\\AliceFixturesBundle\\h4ccAliceFixturesBundle',
            ),
            ...
            'web_profiler_extra.data_collector.assetic.class' => 'Elao\\WebProfilerExtraBundle\\DataCollector\\AsseticDataCollector',
            'web_profiler_extra.data_collector.assetic.display_in_wdt' => true,
            ...
            'h4cc_alice_fixtures.loader.factory.class' => 'h4cc\\AliceFixturesBundle\\Loader\\Factory',
            'h4cc_alice_fixtures.manager.class' => 'h4cc\\AliceFixturesBundle\\Fixtures\\FixtureManager',
            'h4cc_alice_fixtures.orm.doctrine.class' => 'Nelmio\\Alice\\ORM\\Doctrine',
            'h4cc_alice_fixtures.orm.schema_tool.doctrine.class' => 'h4cc\\AliceFixturesBundle\\ORM\\DoctrineORMSchemaTool',
            'h4cc_alice_fixtures.orm.schema_tool.mongodb.class' => 'h4cc\\AliceFixturesBundle\\ORM\\MongoDBODMSchemaTool',
            'data_collector.templates' => array(
                ...
                'web_profiler_extra.data_collector.routing' => array(
                    0 => 'routing',
                    1 => 'WebProfilerExtraBundle:Collector:routing',
                ),
                'web_profiler_extra.data_collector.container' => array(
                    0 => 'container',
                    1 => 'WebProfilerExtraBundle:Collector:container',
                ),
                'web_profiler_extra.data_collector.assetic' => array(
                    0 => 'assetic',
                    1 => 'WebProfilerExtraBundle:Collector:assetic',
                ),
                'web_profiler_extra.data_collector.twig' => array(
                    0 => 'twig',
                    1 => 'WebProfilerExtraBundle:Collector:twig',
                ),
            ),
        ...
        $this->methodMap = array(
            ...
            'h4cc_alice_fixtures.default_manager' => 'getH4ccAliceFixtures_DefaultManagerService',
            'h4cc_alice_fixtures.loader.factory' => 'getH4ccAliceFixtures_Loader_FactoryService',
            'h4cc_alice_fixtures.orm.schema_tool.doctrine' => 'getH4ccAliceFixtures_Orm_SchemaTool_DoctrineService',
            ...
            'web_profiler_extra.data_collector.twig' => 'getWebProfilerExtra_DataCollector_TwigService',
            'white_october_pagerfanta.view_factory' => 'getWhiteOctoberPagerfanta_ViewFactoryService',
        );
        $this->aliases = array(
            'console.command.sensiolabs_security_command_securitycheckercommand' => 'sensio_distribution.security_checker.command',
            'database_connection' => 'doctrine.dbal.default_connection',
            'debug.templating.engine.twig' => 'templating.engine.twig',
            ...
            'fos_rest.templating' => 'templating.engine.twig',
            'h4cc_alice_fixtures.manager' => 'h4cc_alice_fixtures.default_manager',
            'h4cc_alice_fixtures.orm.default_schema_tool' => 'h4cc_alice_fixtures.orm.schema_tool.doctrine',
            'h4cc_alice_fixtures.orm.schema_tool' => 'h4cc_alice_fixtures.orm.schema_tool.doctrine',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony_test', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_59228c70d62fb502c907fd718ee8b6a8c2105ec067c915dbc349be09b70a8374');
    ...
    /**
     * Gets the 'h4cc_alice_fixtures.default_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \h4cc\AliceFixturesBundle\Fixtures\FixtureManager A h4cc\AliceFixturesBundle\Fixtures\FixtureManager instance.
     */
    protected function getH4ccAliceFixtures_DefaultManagerService()
    {
        return $this->services['h4cc_alice_fixtures.default_manager'] = new \h4cc\AliceFixturesBundle\Fixtures\FixtureManager(array('locale' => 'en_EN', 'seed' => 1, 'do_flush' => true), $this->get('doctrine'), $this->get('h4cc_alice_fixtures.loader.factory'), $this->get('h4cc_alice_fixtures.orm.schema_tool.doctrine'));
    }

    /**
     * Gets the 'h4cc_alice_fixtures.loader.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \h4cc\AliceFixturesBundle\Loader\Factory A h4cc\AliceFixturesBundle\Loader\Factory instance.
     */
    protected function getH4ccAliceFixtures_Loader_FactoryService()
    {
        return $this->services['h4cc_alice_fixtures.loader.factory'] = new \h4cc\AliceFixturesBundle\Loader\Factory();
    }

    /**
     * Gets the 'h4cc_alice_fixtures.orm.schema_tool.doctrine' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \h4cc\AliceFixturesBundle\ORM\DoctrineORMSchemaTool A h4cc\AliceFixturesBundle\ORM\DoctrineORMSchemaTool instance.
     */
    protected function getH4ccAliceFixtures_Orm_SchemaTool_DoctrineService()
    {
        return $this->services['h4cc_alice_fixtures.orm.schema_tool.doctrine'] = new \h4cc\AliceFixturesBundle\ORM\DoctrineORMSchemaTool($this->get('doctrine'));
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Europe/Madrid', true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'FOS\\RestBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Sylius\\Bundle\\ResourceBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sylius/resource-bundle/Resources/config/serializer'), 'WhiteOctober\\PagerfantaBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/white-october/pagerfanta-bundle/WhiteOctober/PagerfantaBundle/Resources/config/serializer'), 'AppBundle' => (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/doctrine/doctrine-fixtures-bundle/Doctrine/Bundle/FixturesBundle/Resources/config/serializer'), 'Elao\\WebProfilerExtraBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/elao/web-profiler-extra-bundle/Resources/config/serializer'), 'h4cc\\AliceFixturesBundle' => (dirname(dirname(dirname(__DIR__))).'/vendor/h4cc/alice-fixtures-bundle/Resources/config/serializer')));
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Elao\WebProfilerExtraBundle\DataCollector\RoutingDataCollector($this->get('router'), true));
        $instance->add(new \Elao\WebProfilerExtraBundle\DataCollector\ContainerDataCollector($b, true));
        $instance->add(new \Elao\WebProfilerExtraBundle\DataCollector\AsseticDataCollector($this, true));
        $instance->add($this->get('web_profiler_extra.data_collector.twig'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Elao\WebProfilerExtraBundle\TwigProfilerEngine A Elao\WebProfilerExtraBundle\TwigProfilerEngine instance.
     */
    protected function getTemplating_Engine_TwigService()
    {
        $a = $this->get('twig');

        $b = new \Symfony\Bundle\TwigBundle\Debug\TimedTwigEngine($a, $this->get('templating.name_parser'), $this->get('templating.locator'), $this->get('debug.stopwatch'));

        $this->services['templating.engine.twig'] = $instance = new \Elao\WebProfilerExtraBundle\TwigProfilerEngine($a, $b, $this->get('web_profiler_extra.data_collector.twig'));

        $b->setDefaultEscapingStrategy(array(0 => $instance, 1 => 'guessDefaultEscapingStrategy'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/sylius/resource-bundle/Resources/views'), 'SyliusResource');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/elao/web-profiler-extra-bundle/Resources/views'), 'WebProfilerExtra');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54a1a0fd052d8')), true);
    ...
    /**
     * Gets the 'web_profiler_extra.data_collector.twig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \Elao\WebProfilerExtraBundle\DataCollector\TwigDataCollector A Elao\WebProfilerExtraBundle\DataCollector\TwigDataCollector instance.
     */
    protected function getWebProfilerExtra_DataCollector_TwigService()
    {
        return $this->services['web_profiler_extra.data_collector.twig'] = new \Elao\WebProfilerExtraBundle\DataCollector\TwigDataCollector($this, true);
    }
