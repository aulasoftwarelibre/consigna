...
use MovedBundle\Doctrine\Extensions\UploadedFileInfo;
use MovedBundle\Event\ConsignaEvents;
use MovedBundle\Event\FileEvent;
use MovedBundle\Event\UserAccessSharedEvent;
use AppBundle\Entity\File;
use AppBundle\Entity\Interfaces\FileInterface;
use AppBundle\Form\Type\FileAnonCreateType;
use AppBundle\Form\Type\FileAnonDownloadType;
